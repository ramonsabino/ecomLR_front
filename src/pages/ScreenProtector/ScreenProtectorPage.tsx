...
const ScreenProtectorPage: React.FC = () => {
  ...
  const pelicula = filteredProducts.filter(products => products.category === 'Peliculas');
            ...
            <ListItem>
              <FormControl fullWidth>
                ...
                >
                  ...
                  <MenuItem value="Cerâmica">Cerâmica</MenuItem>
                </Select>
              </FormControl>
            </ListItem>
            <ListItem>
  ...
  export default ScreenProtectorPage;
